...
export const LiquidGaugeProgress = ({ size, value }: Props) => {
  ...
  const font = useFont(require('../../../assets/fonts/Manrope-Bold.ttf'), fontSize); // create font with font file and size
  ...
  return (
    <Canvas style={{ width: size, height: size }}>
      ...
      />
      <Group clip={clipPath}>
        <Circle cx={radius} cy={radius} r={fillCircleRadius} color={colors.green[200]} />
